              ...
              <div class="card-body p-4">
                ...
                <div class="p-2 mt-4">
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    <b-alert v-model="registerSuccess" class="mt-3" variant="success" dismissible>Email successfully
                      sent.</b-alert>
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="auth-certify-check">
                        <p class="mb-0 fs-12 text-muted fst-italic">
                          I certify that I am part of a professional medical organisation.
                        </p>
                      </label>
                    </div>
                    ...
                    <div class="mt-4">
                      <button @click="tryToRegisterIn" class="btn btn-success w-100" type="submit">
