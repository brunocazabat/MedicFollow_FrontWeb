            ...
            <div class="card mt-4">
              <div class="card-body p-4">
                <div class="text-center">
                  <p class="text-muted" data-key="t-completeprof">
                    {{ $t("t-completeprof") }}
                  </p>
                </div>
                <div class="p-2 mt-4">
                  ...
                  <form
                    ...
                    @submit.prevent="RegisterInInfos"
                  >
                    <div
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        id="famillyname"
                        v-bind:placeholder="$t('t-enterfamname')"
                        data-key="t-enterfamname"
                        required
                      />
                      <div
                    ...
                    <div class="mb-3">
                      <label for="name" class="form-label" data-key="t-name"
                        >{{ $t("t-name") }}
                        <span class="text-danger">*</span></label
                      >
                      <input
                        ...
                        id="name"
                        v-bind:placeholder="$t('t-entername')"
                        data-key="t-entername"
                        required
                      />
                      <div
                    ...
                    <div class="mb-3">
                      ...
                      >
                        <Popper placement="right" :show="hover">
                          <p class="text-danger" data-key="t-passreq">
                            {{ $t("t-passreq") }}
                          </p>
                          <template #content>
                            <div>
                              <p class="invalid fs-12 mb-2" data-key="t-12char">
                                {{ $t("t-12char") }}
                              </p>
                              <p
