                ...
                <table class="table align-middle table-nowrap mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>$2,300</td>
                      <td><a href="javascript:void(0);" class="link-success">View More <em
                            class="ri-arrow-right-line align-middle"></em></a></td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="hstack gap-3 flex-wrap">
                              <a href="javascript:void(0);" class="link-success fs-15"><em
                                  class="ri-edit-2-line"></em></a>
                              <a href="javascript:void(0);" class="link-danger fs-15"><em
                                  class="ri-delete-bin-line"></em></a>
                            </div>
                          </td>
                        </tr>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="javascript:void(0);"><em
                                class="ri-download-2-line fs-17 lh-1 align-middle"></em></a></td>
                        </tr>
                        <tr>
                          <th scope="row">
                            <div class="form-check">
                ...
                <table class="table align-middle table-nowrap mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Cleo Carson</td>
                      <td>$4,521</td>
                      <td><a href="javascript:void(0);"><em class="ri-download-2-line fs-17 lh-1 align-middle"></em></a>
                      </td>
                    </tr>
...
&lt;/table&gt;</code></pre>
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">Use <code>table-bordered</code> class to show borders on all sides of the table and
              cells.</p>
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">Use <code>border-</code> class with color variation class to set table border color.
            </p>
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">Use <code>table-sm</code> class to create any table more compact by cutting all cell
              padding in half.</p>
...
&lt;/table&gt;</code></pre>
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">Use <code>table-light</code> or <code>table-dark</code> class to create &lt;thead&gt;
              appear light or dark.</p>
...
&lt;/table&gt;</code></pre>
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">You can also put the <code>&lt;caption&gt;</code> attribute on the top of the table
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">Example of basic table nesting. Border styles, active styles, and table variants are
              not inherited by nested tables.</p>
            <div class="live-preview">
              <div class="table-responsive">
                <table class="table table-nowrap mb-0">
                  <thead class="table-light">
      ...
      <div class="col-xl-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="text-muted">Table cells of <code>&lt;thead&gt;</code> are always vertical aligned to the bottom.
              Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from <code>&lt;table&gt;</code> and are
              aligned to the the top by default. Use the vertical align classes to re-align where needed.</p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>This here is some placeholder text, intended to take up quite a bit of vertical space, to
                        demonstrate how the vertical alignment works in the preceding cells. Use the vertical align
                        classes to re-align where needed. inherit their alignment from and are aligned to the the top by
                        default.</td>
                    </tr>
