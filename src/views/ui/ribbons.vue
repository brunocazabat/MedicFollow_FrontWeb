          ...
          <div class="card-body">
                    ...
                    <div class="card-body">
                      ...
                      <div class="ribbon-content mt-4 text-muted">
                        <p class="mb-0">
                          ...
                          mattis dui. Aliquam mattis dictum aliquet. Nulla
                          sapien mauris, eleifend et sem ac, commodo dapibus
                          odio.
                        </p>
                      </div>
                    </div>
            ...
            <div class="d-none code-view">
              <pre
                ...
                style="height: 275px"
              ><code>&lt;!-- Rounded Ribbon --&gt;
&lt;b-card class=&quot;ribbon-box border mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
...
<code>b-card class=&quot;ribbon-box border mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
...
<code>&lt;!-- Right Ribbon --&gt;
&lt;b-card class=&quot;ribbon-box border right mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
        &lt;div class=&quot;ribbon ribbon-info round-shape&quot;&gt;Info&lt;/div&gt;
        &lt;h5 class=&quot;fs-14 text-start&quot;&gt;Rounded Ribbon Right&lt;/h5&gt;
        &lt;div class=&quot;ribbon-content mt-4 text-muted&quot;&gt;
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="shape-ribbon-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
...
<code>&lt;b-card class=&quot;ribbon-box border mb-lg-0 right&quot;&gt;
    &lt;b-card no-body&gt;
        &lt;div class=&quot;ribbon ribbon-info ribbon-shape&quot;&gt;Info&lt;/div&gt;
        &lt;h5 class=&quot;fs-14 text-start&quot;&gt;Ribbon Shape Right&lt;/h5&gt;
        &lt;div class=&quot;ribbon-content text-muted mt-4&quot;&gt;
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="ribbons01-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            ...
            <div class="d-none code-view">
              <pre
                class="language-markup"
                style="height: 275px"
              ><code>&lt;b-card class=&quot;ribbon-box border ribbon-fill mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
...
<code>&lt;!-- Right Ribbon --&gt;
&lt;b-card class=&quot;ribbon-box border ribbon-fill right mb-lg-0&quot;&gt;
    &lt;b-card no-body&gt;
                  ...
                  <div class="card ribbon-box border mb-lg-0">
                    <div class="card-body text-muted">
                      ...
                      <p class="mb-0">
                        ...
                        dui. Aliquam mattis dictum aliquet. Nulla sapien mauris,
                        eleifend et sem ac, commodo dapibus odio. Vivamus
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="ribbon-three-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="ribbon-hover-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <div class="live-preview">
              <div class="row g-3">
                <p class="text-muted">
                  Use
                  <code>trending-ribbon</code> class to show ribbon with
                  hovering effect.
                </p>
                <div class="col-xxl-4">
                ...
                <div class="col-xxl-4">
                  <div
                    class="card ribbon-box right border overflow-hidden mb-lg-0"
                  >
                    <div class="card-body text-muted">
                      <div
                        class="ribbon ribbon-info ribbon-shape trending-ribbon"
            ...
            <div class="d-none code-view">
              <pre
                class="language-markup"
                style="height: 275px"
              ><code>&lt;b-card class=&quot;ribbon-box border overflow-hidden&quot;&gt;
    &lt;b-card no-body class=&quot;text-muted&quot;&gt;
...
<code>&lt;b-card class=&quot;ribbon-box right border overflow-hidden&quot;&gt;
    &lt;b-card no-body class=&quot;text-muted&quot;&gt;
        &lt;div class=&quot;ribbon ribbon-info ribbon-shape trending-ribbon&quot;&gt;
