            ...
            <div class="live-preview">
              <div class="bg-light p-3 text-center">
                <div class="row align-items-start" style="min-height: 6rem;">
                  ...
                  <div class="col-sm-4">
                    <div class="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">col-sm-4</div>
                  </div>
                  <div class="col-sm-4">
                    <div class="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">col-sm-4</div>
                  </div>
            ...
            <div class="live-preview">
              <div class="bg-light p-3 text-center">
                <div class="row justify-content-start">
                  <div class="col-sm-4">
                    <div class="bg-soft-primary text-primary rounded p-2">justify-content-start</div>
                  </div>
                </div>
                <div class="row justify-content-center">
                  <div class="col-sm-4">
                    <div class="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">justify-content-center</div>
                  </div>
                </div>
                <div class="row justify-content-end">
                  <div class="col-sm-4">
                    <div class="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">justify-content-end</div>
                  </div>
                </div>
              </div>
            </div>
