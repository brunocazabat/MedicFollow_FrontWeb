      ...
      <div class="col-xxl-6">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="vertically-centered" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>modal-dialog-centered</code> class to show vertically center
              the modal.
            </p>
            <div class="live-preview">
              <div>
      ...
      <div class="col-xxl-6">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="grid-modal-showcode" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>container-fluid</code> class within the modal-body to
      ...
      <div class="col-xxl-6">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="static-backdrop" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>data-bs-backdrop="static"</code> to modal not to close when
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              <code>data-bs-toggle</code> attributes. Please note multiple
                    ...
                    <div class="modal-content">
                      <div class="modal-body text-center p-5">
                        <lord-icon
                          ...
                          trigger="loop"
                          colors="primary:#4b38b3,secondary:#45CB85"
...
&lt;/div&gt;</code></pre>
      ...
      <div class="col-xxl-6">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="tooltip-popover-modal" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              <a href="https://getbootstrap.com/docs/5.1/components/tooltips/"
                >Tooltips</a
              >
              and
              <a href="https://getbootstrap.com/docs/5.1/components/popovers/"
                >Popovers</a
              >
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <div class="mx-auto">
                        <a
                          href="javascript:void(0);"
                          class="btn btn-link shadow-none fw-medium"
                        >
                          Read More
                          <em
      ...
      <div class="col-xxl-6">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="scrollable-modal" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>modal-dialog-scrollable</code> class to create a modal
              scrollable.
            </p>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="d-flex mt-2">
                          ...
                          <div class="flex-grow-1 ms-2">
                            <p class="text-muted mb-0">
                              For that very reason, I went on a quest and spoke
                              to many different professional graphic designers
                        ...
                        <div class="d-flex mt-2">
                          ...
                          <div class="flex-grow-1 ms-2">
                            <p class="text-muted mb-0">
                              ...
                              like sans serif with serif, short with tall, or
                        ...
                        <div class="d-flex mt-2">
                          ...
                          <div class="flex-grow-1 ms-2">
                            <p class="text-muted mb-0">
                              Opposites attract, and that’s a fact. It’s in our
                              nature to be interested in the unusual, and that’s
                              why using contrasting colors in Graphic Design is
                              a must. It’s eye-catching, it makes a statement,
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              <code>data-bs-*</code> attributes to vary the contents of the
              modal depending on which button was clicked.
            </p>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="optional-sizes" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>modal-fullscreen</code>, <code>modal-xl</code>,
                  ...
                  <div class="modal-dialog modal-fullscreen">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a
                          href="javascript:void(0);"
                          class="btn btn-link link-success shadow-none fw-medium"
                          data-bs-dismiss="modal"
                        >
                          <em class="ri-close-line me-1 align-middle"></em>
                          Close
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <div
                class="form-check form-switch form-switch-right form-switch-md"
              >
                <label for="fullscreen-modal" class="form-label text-muted"
                  >Show Code</label
                >
                <input
                  class="form-check-input code-switcher"
          ...
          <div class="card-body">
            <p class="text-muted text-muted">
              Below mentioned modifier classes are used to show fullscreen modal
              as per minimum screen requirement.
            </p>
            <div class="live-preview">
              <div>
                <div class="hstack gap-2 flex-wrap">
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              Use
              <code>fadeInRight</code>, <code>fadeInLeft</code>,
              <code>fadeInUp</code>, <code>flip</code>, or
              <code>zoomIn</code> class to modal class to set different modal
              with animation effect respectively.
            </p>
            <div class="live-preview">
              <div>
                <div class="hstack gap-2 flex-wrap">
                  <button
                    ...
                    class="btn btn-primary"
                    data-bs-toggle="modal"
                    data-bs-target="#fadeInRightModal"
                  >
                    Fade In Right Modal
                  </button>
                  <button
                    ...
                    class="btn btn-primary"
                    data-bs-toggle="modal"
                    data-bs-target="#fadeInleftModal"
                  >
                    Fade In Left Modal
                  </button>
                  <button
                ...
                <div
                  id="fadeInRightModal"
                  class="modal fade fadeInRight"
                  tabindex="-1"
                  aria-labelledby="fadeInRightModalLabel"
                  aria-hidden="true"
                  style="display: none"
                >
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="fadeInRightModalLabel">
                          Modal Heading
                        </h5>
                        <button
                          type="button"
                ...
                <div
                  ...
                  tabindex="-1"
                  aria-labelledby="fadeInleftModalLabel"
                  aria-hidden="true"
                  style="display: none"
                >
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="fadeInleftModalLabel">
                          Modal Heading
                        </h5>
                        <button
                          type="button"
                ...
                <div
                  id="fadeInUpModal"
                  class="modal fade fadeInUp"
                  tabindex="-1"
                  aria-labelledby="fadeInUpModalLabel"
                  aria-hidden="true"
                  style="display: none"
                >
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="fadeInUpModalLabel">
                          Modal Heading
                        </h5>
                        <button
                          type="button"
                ...
                >
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="flipModalLabel">
                          Modal Heading
                        </h5>
                        <button
                          type="button"
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted text-muted">
              Use
              <code>modal-dialog-right</code>, <code>modal-dialog-bottom</code>,
              or <code>modal-dialog-bottom-right</code> class to modal-dialog
              ...
              <div>
                <div class="hstack gap-2 flex-wrap">
                  ...
                  <button
                    ...
                    class="btn btn-danger"
                    data-bs-toggle="modal"
                    data-bs-target="#bottom-rightModal"
                  >
                    Bottom Right Modal
                  </button>
                </div>
                  ...
                  <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-2">
                      ...
                      <p class="text-muted fs-15 mb-4">
                        Successful transaction is the status of operation whose
                        result is the payment of the amount paid by the customer
                        in favor of the merchant.
                      </p>
                      <div class="hstack gap-2 justify-content-center">
                        <button class="btn btn-primary">New transaction</button>
                        <button class="btn btn-soft-success">
                          <em class="ri-links-line align-bottom"></em> Copy
                          tracking link
                        </button>
                      </div>
                    </div>
                  ...
                  <div class="modal-body login-modal p-5">
                    ...
                    <div class="vstack gap-2 justify-content-center">
                      <button class="btn btn-light">
                        <em
                          class="ri-google-fill align-bottom text-danger"
                        ></em>
                        Google
                      </button>
                      <button class="btn btn-info">
                        <em class="ri-facebook-fill align-bottom"></em> Facebook
                      </button>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-7">
                      <div class="modal-body p-5">
                        <h2 class="lh-base">
                          ...
                          <span class="text-danger">20% off</span> experiences!
                        </h2>
                        <p class="text-muted mb-4">
                          A free bet is a bet which is provided by a betting
                          site for a customer to place and then benefit from the
                          winnings. Free bets are commonly used as welcome
                          offers.
                        </p>
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="exampleCheck1"
                            >By subscribing to a particular channel or user on
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 overflow-hidden">
                  ...
                  <div class="alert alert-success rounded-0 mb-0">
                    <p class="mb-0">
                      Up to <span class="fw-semibold">50% OFF</span>, Hurry up
                    ...
                    <form>
                      ...
                      <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="checkTerms"
                          >I agree to the
                          <span class="fw-semibold">Terms of Service</span> and
