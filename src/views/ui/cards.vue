      ...
      <div class="col-sm-6 col-xl-3">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              At missed advice my it no sister. Miss told ham dull knew see she
        ...
        <div class="card">
          ...
          <div class="card-footer">
            <a href="javascript:void(0);" class="card-link link-secondary">
              Read More
              <em class="ri-arrow-right-s-line ms-1 align-middle lh-1"></em>
            </a>
            <a href="javascript:void(0);" class="card-link link-success">
              Bookmark
              <em class="ri-bookmark-line align-middle ms-1 lh-1"></em>
            </a>
          </div>
        </div>
        <!-- end card -->
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">
              ...
              meta-services. Distinctively re-engineer revolutionary
              meta-services.
            </p>
          </div>
          <div class="card-footer">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text text-muted mb-0">
                  ...
                  implementation, and education of businesses. Miss told ham
                  dull knew see she spot near can. Spirit her entire her called.
                </p>
              </div>
              <div class="card-footer">
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title mb-3">
              <em class="ri-user-3-fill align-middle me-1 text-muted"></em>
              Natasha Carey
            </h4>
            <p class="text-muted">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-muted">
              ...
              has become more and more popular over the years.
            </p>
            <p class="text-muted mb-0">
      ...
      <div class="col-xl-4">
        <div class="card">
          <div class="card-header">
            <h6 class="card-title mb-0">
              <em class="ri-gift-line align-middle me-1 lh-1"></em> You've made
              it!
            </h6>
          </div>
          <div class="card-body">
            <p class="text-muted">
              ...
              basics, I came up with a list of 30 graphic design tips that you
              can start implementing. Each design is a new, unique piece of art
          ...
          <div class="card-body collapse show" id="collapseexample1">
            <div class="d-flex">
              ...
              <div class="flex-grow-1 ms-2 text-muted">
                ...
                is hidden by default but revealed when the user activates.
              </div>
            </div>
              ...
              <div class="card-img-overlay p-0 d-flex flex-column">
                ...
                <div class="card-body">
                  <p class="card-text text-white mb-2">
                    ...
                    make your unpleasant for the reader.
                  </p>
                  <p class="card-text">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="card-text text-muted">
                  Exercitation +1 labore velit, blog sartorial PBR leggings next
                  level wes anderson artisan four loko farm-to-table craft beer
                  twee. ommodo enim craft beer mlkshk aliquip jean shorts
                  ullamco.
                </p>
                <p class="card-text mb-0">Last updated 3 mins ago</p>
              </div>
                ...
                <div class="col-md-8">
                  ...
                  <div class="card-body">
                    <p class="card-text mb-2">
                      ...
                      different professional graphic designers and asked them
                      what graphic design tips they live.
                    </p>
                    <p class="card-text">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <p class="card-text">
                      <span class="fw-medium">Jeffrey Montgomery</span> (Graphic
            ...
            <div class="card card-success">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <p class="card-text">
                      <span class="fw-medium">Charles Dickens</span> (Financial
            ...
            <div class="card card-info">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <p class="card-text">
                      <span class="fw-medium">Oliver Phillips</span> (UI/UX
                      Designer) started a new conversation.
                    </p>
                  </div>
                </div>
        ...
        <div class="card card-warning">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="card-text">
                  <span class="fw-medium">Rebecca Swartz</span> (Graphic
                  Designer) started a new conversation.
                </p>
              </div>
            </div>
        ...
        <div class="card card-danger">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="card-text">
                  <span class="fw-medium">Betty Richards</span> (Back End
                  Developer) started a new conversation.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card card-dark">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="card-text">
                  <span class="fw-medium">Brooke Hayes</span> (Founder & CEO)
        ...
        <div class="card card-secondary">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="card-text">
                  <span class="fw-medium">Bethany Johnson</span> (Team Leader)
                  started a new conversation.
                </p>
              </div>
            </div>
        ...
        <div class="card card-light">
          <div class="card-body">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="card-text">
                  <span class="fw-medium">Amelie Townsend</span> (UI/UX
                  Designer) started a new conversation.
                </p>
              </div>
            </div>
          ...
          <div class="col-xxl-4">
            <div class="card border card-border-primary">
              <div class="card-header">
                ...
                <h6 class="card-title mb-0">
                  Handle to Forcast
                  <span class="badge bg-danger align-middle fs-10">Poor</span>
                </h6>
              </div>
              <div class="card-body">
                <p class="card-text">
                  Whether article spirits new her covered hastily sitting her.
                  Money witty books nor son add build on the card Chicken age
                  had evening believe but proceed pretend mrs.
                </p>
                <div class="text-end">
          ...
          <div class="col-xxl-4">
            <div class="card border card-border-success">
              ...
              <div class="card-body">
                ...
                <div class="text-end">
                  <a href="javascript:void(0);" class="link-success fw-medium">
                    Read More
                    <em class="ri-arrow-right-line align-middle"></em>
                  </a>
                </div>
          ...
          <div class="col-xxl-4">
            <div class="card border card-border-info">
              ...
              <div class="card-body">
                ...
                <div class="text-end">
                  <a href="javascript:void(0);" class="link-info fw-medium">
                    Read More
                    <em class="ri-arrow-right-line align-middle"></em>
                  </a>
                </div>
      ...
      <div class="col-xxl-4">
        <div class="card border card-border-warning">
          <div class="card-header">
            <h6 class="card-title mb-0">
              Check your Payment
              <span class="badge bg-warning align-middle fs-10">Pending</span>
            </h6>
          </div>
          <div class="card-body">
            <p class="card-text">
              They all have something to say beyond the words on the page. They
              can come across as casual or neutral, exotic or graphic. Cosby
              sweater eu banh mi, qui irure terry richardson ex squid.
            </p>
            <div class="text-end">
              <a href="javascript:void(0);" class="link-warning fw-medium">
                Read More
                <em class="ri-arrow-right-line align-middle"></em>
              </a>
            </div>
      ...
      <div class="col-xxl-4">
        <div class="card border card-border-danger">
          <div class="card-header">
            <h6 class="card-title mb-0">
              Your Ordered Cancel
              <span class="badge bg-danger align-middle fs-10">Cancel</span>
            </h6>
          </div>
          <div class="card-body">
            <p class="card-text">
            ...
            <div class="text-end">
              <a href="javascript:void(0);" class="link-danger fw-medium">
                Read More
                <em class="ri-arrow-right-line align-middle"></em>
              </a>
            </div>
      ...
      <div class="col-xxl-4">
        <div class="card border card-border-dark">
          ...
          <div class="card-body">
            ...
            <div class="text-end">
              <a href="javascript:void(0);" class="link-dark fw-medium">
                Read More
                <em class="ri-arrow-right-line align-middle"></em>
              </a>
            </div>
      ...
      <div class="col-xxl-4">
        <div class="card border card-border-secondary">
          ...
          <div class="card-body">
            ...
            <div class="text-end">
              <a href="javascript:void(0);" class="link-secondary fw-medium">
                Read More
                <em class="ri-arrow-right-line align-middle"></em>
              </a>
            </div>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              Exercitation +1 labore velit, blog sartorial PBR leggings next
              level wes anderson artisan four loko farm-to-table craft beer
              twee. ommodo enim craft beer mlkshk aliquip jean shorts ullamco.
            </p>
          </div>
          <div class="card-footer">
            <p class="card-text">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex position-relative">
                  <img src="@/assets/images/users/avatar-3.jpg" class="flex-shrink-0 me-3 avatar-xl rounded"
                    alt="..." />
                  <div>
                ...
                <div class="row g-0 bg-light position-relative">
                  ...
                  <div class="col-md-7 p-4">
                    ...
                    <p>
                      ...
                      custom component. It is intended to mimic what some
