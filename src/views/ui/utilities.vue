            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Use border utilities to add or remove an element’s borders. Choose from all borders or one at a time.</p>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Use below-mentioned class to an element to easily round its corners.</p>
                        <div class="live-preview">
                            <div>
                                <div>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Use below-mentioned class to an element to display the value of components and more with our display utilities.</p>
                        <div class="live-preview">
                            <div>
                                <div class="row">
                                    <div class="col-lg-6">
                            ...
                            <div class="mt-4">
                                ...
                                <p
                                    class="text-muted"
                                >Change the display value of elements when printing with our print display utility classes.</p>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Use the below-mentioned class to an element to custom display the value of components and more with our display utilities.</p>
                        <div class="live-preview">
                            <div>
                                <div class="table-responsive">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-3">
                            Use
                            <code>vstack</code> class to create vertical layouts. Stacked items are full-width by default. Use
                            <code>gap-</code> class with variation to add space between items.
                        </p>
                        <div class="live-preview">
                            <div class="vstack gap-3">
                                <div class="bg-light border p-1 px-2 shadow">First item</div>
                                <div class="bg-light border p-1 px-2 shadow">Second item</div>
                                <div class="bg-light border p-1 px-2 shadow">Third item</div>
                            </div>
...
<code>&lt;div class=&quot;vstack gap-2&quot;&gt;
    ...
    &lt;b-button variant=&quot;outline-secondary shadow-none&quot;&gt;Cancel&lt;/b-button&gt;
&lt;/div&gt;</code></pre>
                        </div>
                    </div>
                    <!-- end card-body -->
            ...
            <div class="col-xxl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted mb-3">
                            Use
                            <code>hstack</code> class to create horizontal layouts. Stacked items are full-width by default. Use
                            <code>gap-</code> class with variation to add space between items.
                        </p>
                        ...
                        <div class="live-preview">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="hstack gap-3">
                                    <div class="bg-light border p-1 px-2 shadow">First item</div>
                                    <div class="bg-light border p-1 px-2 ms-auto shadow">Second item</div>
                                    <div class="bg-light border p-1 px-2 shadow">Third item</div>
                                </div>
                                <div class="hstack gap-3 mt-3">
                                    ...
                                    <div class="bg-light border p-1 px-2 ms-auto shadow">Third item</div>
                                </div>
                            </div>
...
<code>&lt;div class=&quot;hstack gap-3&quot;&gt;
    &lt;div class=&quot;bg-light border p-1 px-2 shadow&quot;&gt;First item&lt;/div&gt;
    &lt;div class=&quot;bg-light border p-1 px-2 shadow ms-auto&quot;&gt;Second item&lt;/div&gt;
    &lt;div class=&quot;bg-light border p-1 px-2 shadow&quot;&gt;Third item&lt;/div&gt;
&lt;/div&gt;
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                >This paragraph will be entirely selected when clicked by the user.</p>
                                <p
                                    class="user-select-auto"
                                >This paragraph has default select behavior.</p>
                                <p
                                    class="user-select-none mb-0"
                                >This paragraph will not be selectable when clicked by the user.</p>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <div>
                                <p>
                                    <a href="#" class="text-success pe-none" tabindex="-1">This link</a> can not be clicked.
                                </p>
                                <p>
                                    <a href="#" class="text-success pe-auto">This link</a> can be clicked (this is default behavior).
                                </p>
                                <p class="pe-none mb-0">
                                    <a href="#" class="text-success" tabindex="-1">This link</a> can not be clicked because the
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted">
                            Use
                            <code>overflow</code> property on the fly with four default values and classes.
                        </p>
                        <div class="live-preview">
                            <div>
                                <div class="row">
                                        ...
                                        <div class="mt-4 mt-xl-0">
                                            ...
                                            <div class="d-md-flex bg-light">
                                                ...
                                                >
                                                    ...
                                                    <code>.overflow-auto</code> on an element with set width and height dimensions. By design, this content will vertically scroll. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="mt-4 mt-xl-0">
                                            ...
                                            <div class="d-md-flex bg-light">
                                                ...
                                                >
                                                    This is an example of using
                                                    <code>.overflow-hidden</code> on an element with set width and height dimensions. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="mt-4 mt-xl-0">
                                            ...
                                            <div class="d-md-flex bg-light">
                                                ...
                                                >
                                                    This is an example of using
                                                    <code>.overflow-visible</code> on an element with set width and height dimensions.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="mt-4 mt-xl-0">
                                            ...
                                            <div class="d-md-flex bg-light">
                                                ...
                                                >
                                                    This is an example of using
                                                    <code>.overflow-scroll</code> on an element with set width and height dimensions. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p
                            class="text-muted"
                        >Use below mentioned classes to arrange elements easily with the edge positioning utilities.The format is {property}-{position}.</p>
                        <div class="live-preview">
                            <div>
                                <div class="row">
