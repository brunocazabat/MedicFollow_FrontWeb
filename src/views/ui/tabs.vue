    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>b-tabs</code> to generate a default tabbed interface.
            </p>
            <!-- Nav tabs -->
            ...
            <div class="tab-content text-muted">
              <div class="tab-pane" id="home" role="tabpanel">
                ...
                <p class="mb-0">
                  ...
                  That's why it's important to think about your message, then
                  choose a font that fits. Cosby sweater eu banh mi, qui irure
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>&lt;b-nav tabs justified&gt;</code> class to generate
              equal-width elements with all horizontal space will be occupied by
              nav links.
            </p>
            <!-- Nav tabs -->
    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>&lt;b-nav card-header pills&gt;</code> class to generate
              particular selected nav links without borders.
            </p>
            <!-- Nav tabs -->
              ...
              <div class="tab-pane active" id="home-1" role="tabpanel">
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <em class="ri-checkbox-circle-fill text-success"></em>
                  </div>
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>&lt;b-nav card-header pills justified&gt;</code> class
              to generate equal-width elements without borders, all horizontal
            ...
            <ul class="nav nav-pills nav-justified mb-3" role="tablist">
              ...
              <li class="nav-item">
                <a
                  class="nav-link waves-effect waves-light"
                  data-bs-toggle="tab"
                  href="#pill-justified-messages-1"
                  role="tab"
                >
                  Messages
                </a>
              ...
              <li class="nav-item">
                <a
                  class="nav-link waves-effect waves-light"
                  data-bs-toggle="tab"
                  href="#pill-justified-settings-1"
                  role="tab"
                >
                  Settings
                </a>
            ...
            <div class="tab-content text-muted">
              <div class="tab-pane active" id="home2" role="tabpanel">
                <p class="flex-grow-1 mb-0">
                  ...
                  delectus.commodo enim craft beer mlkshk aliquip jean shorts
                  ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda
                  labore aesthetic magna delectus. If you’re using multiple
                  elements, make sure that your principal object is larger than
                  assumenda.
                </p>
              </div>
              <div class="tab-pane" id="profile2" role="tabpanel">
                <p class="me-3 mb-0">
                  ...
                  />
                  Experiment and play around with the fonts that you already
                  have in the software you’re working with reputable font
                  websites. commodo enim craft beer mlkshk aliquip jean shorts
                  ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda
                  labore aesthetic magna delectus.commodo enim craft beer mlkshk
                  aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud
                  organic, assumenda labore aesthetic magna delectus Scale all
                  elements of your design: text, elements, buttons, everything.
              ...
              <div class="tab-pane" id="messages2" role="tabpanel">
                <p class="ms-3 mb-0">
                  ...
                  squid scenester freegan cosby sweater. Fanny pack portland
                  seitan DIY, art party locavore wolf cliche high life echo park
                  Austin. Cred vinyl keffiyeh DIY salvia PBR, beer mlkshk
                  aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud
                  organic, assumenda labore aes Homo nostrud organic, assumenda
                  labore aesthetic magna delectus Scale all elements of your
                  design: text, elements, buttons, everything.Increase or
                  decrease the letter spacing depending on the situation and
    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>nav-tabs-custom</code> class to create custom tabs with
              borders.
            </p>
            <!-- Nav tabs -->
            <ul
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <div class="mt-2">
                      <a
                        ...
                        >Read More
                        <em class="ri-arrow-right-line ms-1 align-middle"></em
                      ></a>
                    </div>
                  </div>
                </div>
              ...
              <li class="nav-item">
                ...
                >
                  <span class="d-block d-sm-none"
                    ><em class="mdi mdi-home-variant"></em
                  ></span>
            ...
            <div class="tab-content text-muted">
              <div class="tab-pane active" id="arrow-overview" role="tabpanel">
                ...
                <p class="mb-0">
                  ...
                  <a
                    ...
                    ><b>Fantastic Design</b></a
                  >
                  by using complicated 3D elements. Flat design is your friend.
                  Remember that. And the great thing about flat design is that
                  it has become more and more popular over the years, which is
              ...
              <div class="tab-pane" id="arrow-contact" role="tabpanel">
                ...
                <p class="mb-0">
                  ...
                  your cause. Consistency piques people’s interest is that it
                  has become more and more popular over the years, which is
                  excellent news to the beginner and advanced
                  <a
                    href="javascript:void(0);"
                    class="text-decoration-underline"
                    ><b>Contact Designer</b></a
                  >.
                </p>
              </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-header align-items-xl-center d-xl-flex">
            <p class="text-muted flex-grow-1 mb-xl-0">
              Use <code>card-header-pills</code> class to create header justify
              tab.
            </p>
            <div class="flex-shrink-0">
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>card-footer-tabs</code> class to create the bottom card
              nav justify tab.
            </p>
            <div class="tab-content text-muted">
              <div class="tab-pane active" id="bottomtabs-home" role="tabpanel">
                <h5><em class="ri-home-3-line align-bottom me-1"></em> Home</h5>
                <p class="mb-2">
                  On the note of consistency, color consistency is a MUST. If
                  you’re not trying to create crazy contrast in your design,
                  then a great idea would be for you to use a color palette
                  throughout your entire design. It will subconsciously interest
                  viewers and also is very pleasing to look at.
                </p>
                <p class="mb-0">
                  Any bypasser will stop to see what you have to see, even if
                  your design has nothing to do with them, for the simple fact
                  that it is beautiful to look at.
                </p>
              </div>
              <div class="tab-pane" id="bottomtabs-profile" role="tabpanel">
                <h5>
                  <em class="ri-user-2-line align-bottom me-1"></em> Profile
                </h5>
                <p class="mb-2">
                  Just like in the image where we talked about using multiple
                  fonts, you can see that the background in this graphic design
                  is blurred. Whenever you put text on top of an image, it’s
                  important that your viewers can understand the text, and
                  sometimes that means applying a gaussian readable.
                </p>
                <p class="mb-0">
                  A very bad quack might jinx zippy fowls. Few quips galvanized
                  the mock jury box. Quick brown dogs jump over the lazy fox.
                  The jay, pig, fox, zebra, and my wolves.
                </p>
              </div>
              <div class="tab-pane" id="bottomtabs-messages" role="tabpanel">
                <h5>
                  <em class="ri-mail-line align-bottom me-1"></em> Messages
                </h5>
                <p class="mb-2">
                  Blowzy red vixens fight for a quick jump. Joaquin Phoenix was
                  gazed by MTV for luck. A wizard’s job is to vex chumps quickly
                  in fog. Watch "Jeopardy! ", Alex Trebek's fun TV quiz game.
                ...
                <p class="mb-0">
                  ...
                  from Japan quickly forgot how to waltz.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card-footer bg-transparent border-top">
            <!-- Nav tabs -->
            <ul
              class="nav nav-pills nav-justified card-footer-tabs fs-17"
              role="tablist"
            >
              <li
                class="nav-item"
    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>custom-hover-nav-tabs</code> class to create custom
              hover tabs.
            </p>
          </div>
          <div class="border">
            <ul class="nav nav-pills custom-hover-nav-tabs">
              <li class="nav-item">
                <a
                  ...
                  class="nav-link active"
                >
                  <em class="ri-user-fill nav-icon nav-tab-position"></em>
              ...
              <li class="nav-item">
                <a
                  ...
                  class="nav-link"
                >
                  <em class="ri-file-text-line nav-icon nav-tab-position"></em>
              ...
              <li class="nav-item">
                <a
                  ...
                  class="nav-link"
                >
                  <em class="ri-star-half-line nav-icon nav-tab-position"></em>
              ...
              <div class="col-lg-3">
                ...
                >
                  <a
                    ...
                    aria-selected="true"
                  >
                    <em class="ri-home-4-line d-block fs-20 mb-1"></em>
                    Home</a
                  >
                  <a
                    class="nav-link"
                    ...
                    aria-selected="false"
                  >
                    <em class="ri-user-2-line d-block fs-20 mb-1"></em>
                    Profile</a
                  >
                  <a
                    class="nav-link"
                    ...
                    aria-selected="false"
                  >
                    <em class="ri-mail-line d-block fs-20 mb-1"></em>
                    Messages</a
                  >
                </div>
              </div>
    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>nav-border-top</code> class to create nav tabs with
              border at top.
            </p>
            <!-- Nav tabs -->
            <ul
            ...
            <div class="tab-content text-muted">
              ...
              >
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <em class="ri-checkbox-circle-line text-success"></em>
                  </div>
                  <div class="flex-grow-1 ms-2">
                    Trust fund seitan letterpress, keytar raw denim keffiyeh
                    etsy art party before they sold out master cleanse
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>nav-border-top nav-justified</code> class to create nav
              tabs with border at top with justified tabs position.
            </p>
            <!-- Nav tabs -->
            <ul
            ...
            >
              <li class="nav-item">
                <a
                  class="nav-link active"
                  data-bs-toggle="tab"
                  href="#nav-border-justified-home"
                  role="tab"
                  aria-selected="false"
                >
                  <em class="ri-home-5-line align-middle me-1"></em> Home
                </a>
              </li>
              <li class="nav-item">
                <a
                  class="nav-link"
                  data-bs-toggle="tab"
                  href="#nav-border-justified-profile"
                  role="tab"
                  aria-selected="false"
                >
                  <em class="ri-user-line me-1 align-middle"></em> Profile
                </a>
              </li>
              <li class="nav-item">
                <a
                  class="nav-link"
                  data-bs-toggle="tab"
                  href="#nav-border-justified-messages"
                  role="tab"
                  aria-selected="false"
                >
    ...
    <div class="row">
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              *Use <code>nav-custom-</code> class with modifier class to color
              tabs.
            </p>
            <!-- Nav tabs -->
            <ul
              class="nav nav-pills nav-custom-outline nav-primary mb-3"
              role="tablist"
            >
              <li class="nav-item waves-effect waves-light">
                <a
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- Nav tabs -->
            <ul
              class="nav nav-pills nav-customs nav-danger mb-3"
              role="tablist"
            >
              <li class="nav-item">
                <a
    ...
    <div class="row">
              ...
              >
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    four loko farm-to-table craft beer twee. commodo enim craft
                ...
                <div class="d-flex">
                  <div class="flex-grow-1 me-3">
                    For that very reason, I went on a quest and spoke to many
                    different professional graphic designers and asked them what
                    graphic design tips they live. vinyl cillum PBR. Homo
              ...
              <div class="tab-pane" id="nav-colored-profile" role="tabpanel">
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    craft beer twee. commodo enim craft beer mlkshk aliquip jean
                    shorts ullamco.
                  </div>
                </div>
                <div class="d-flex">
      ...
      <div class="col-xxl-6">
        ...
        <div class="card">
          <div class="card-body">
            <p class="text-muted">
              Use <code>nav-custom-light</code> class to lighten the nav tabs
              area.
            </p>
            <!-- Nav tabs -->
            <ul
              ...
              <div class="tab-pane active" id="nav-light-home" role="tabpanel">
                <div class="d-flex mb-1">
                  <div class="flex-grow-1 me-3">
                    ...
                    websites. commodo enim craft beer mlkshk aliquip jean shorts
                    ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda
                    labore aesthetic magna delectus. pposites attract, and
                    that’s a fact. It’s in our nature to be interested in the
              ...
              <div class="tab-pane" id="nav-light-profile" role="tabpanel">
                <div class="d-flex mb-1">
                  <div class="flex-grow-1 me-3">
                    ...
                    it’s important that your viewers can understand the text,
                    and sometimes that means applying a gaussian readable Any
                    bypasser will stop to see what you have to see, even if your
                ...
                <p class="mb-0">
                  ...
                  perfect spot of its own. commodo enim craft beer mlkshk
              ...
              <div class="tab-pane" id="nav-light-messages" role="tabpanel">
                <div class="d-flex mb-1">
                  <div class="flex-grow-1 me-3">
                    ...
                    gluten-free squid scenester freegan cosby sweater. Fanny
                    pack portland seitan DIY, art party locavore wolf cliche
                    high life echo park Austin On the note of consistency, color
                ...
                <p class="mb-0">
                  Big July earthquakes confound zany experimental vow. My girl
                  wove six dozen plaid jackets before she quit. Six big devils
                  from Japan quickly forgot how to waltz. try again until it
                  looks right, and each assumenda labore aes Homo nostrud
                  organic, assumenda labore aesthetic magna elements, buttons,
                  everything.
                </p>
              </div>
            </div>
