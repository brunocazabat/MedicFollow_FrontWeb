        ...
        <div class="card">
          <div class="card-body text-center">
            ...
            <div class="hstack gap-2 justify-content-center">
              <button class="btn btn-danger btn-sm"><em class="ri-stop-circle-line align-bottom me-1"></em>
                Stop</button>
              <button class="btn btn-success btn-sm"><em class="ri-play-circle-line align-bottom me-1"></em>
                Start</button>
            </div>
          </div>
        </div>
            ...
            <div class="d-flex mb-3">
              ...
              <div class="flex-shrink-0">
                <button type="button" class="btn btn-soft-danger btn-sm shadow-none" data-bs-toggle="modal"
                  data-bs-target="#inviteMembersModal"><em class="ri-share-line me-1 align-bottom"></em> Assigned
                  Member</button>
              </div>
            </div>
            <ul class="list-unstyled vstack gap-3 mb-0">
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-shrink-0">
                    <div class="dropdown">
                      <button class="btn btn-icon btn-sm fs-16 text-muted dropdown shadow-none" type="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <em class="ri-more-fill"></em>
                      </button>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="javascript:void(0);"><em
                              class="ri-eye-fill text-muted me-2 align-bottom"></em>View</a></li>
                        <li><a class="dropdown-item" href="javascript:void(0);"><em
                              class="ri-star-fill text-muted me-2 align-bottom"></em>Favourite</a></li>
                        <li><a class="dropdown-item" href="javascript:void(0);"><em
                              class="ri-delete-bin-5-fill text-muted me-2 align-bottom"></em>Delete</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-shrink-0 ms-2">
                    <div class="d-flex gap-1">
                      <button type="button" class="btn btn-icon text-muted btn-sm fs-18 shadow-none"><em
                          class="ri-download-2-line"></em></button>
                      <div class="dropdown">
                        <button class="btn btn-icon text-muted btn-sm fs-18 dropdown shadow-none" type="button"
                          data-bs-toggle="dropdown" aria-expanded="false">
                          <em class="ri-more-fill"></em>
                        </button>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="javascript:void(0);"><em
                                class="ri-pencil-fill align-bottom me-2 text-muted"></em> Rename</a></li>
                          <li><a class="dropdown-item" href="javascript:void(0);"><em
                                class="ri-delete-bin-fill align-bottom me-2 text-muted"></em> Delete</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 overflow-hidden">
                    <h5 class="fs-13 mb-1"><a href="javascript:void(0);"
                        class="text-body text-truncate d-block">MedicFollow admin.ppt</a></h5>
                    <div>2.4MB</div>
                  </div>
                  <div class="flex-shrink-0 ms-2">
                    <div class="d-flex gap-1">
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-muted">
              ...
              <p>It will be as simple as occidental in fact, it will be Occidental. To an English person, it will seem
                like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is. The
                European languages are members of the same family. Their separate existence is a myth. For science,
                ...
                <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                  <div class="d-flex mb-4">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <p class="text-muted">I am getting message from customers that when they place order always get
                        error message .</p>
                      <a href="javascript: void(0);" class="badge text-muted bg-light"><em class="mdi mdi-reply"></em>
                        Reply</a>
                        ...
                        <div class="flex-grow-1 ms-3">
                          <h5 class="fs-13">
                            <router-link to="/pages/profile" class="text-body">Tonya Noble</router-link> <small
                              class="text-muted">22 Dec 2021 - 02:32PM</small>
                          </h5>
                          <p class="text-muted">Please be sure to check your Spam mailbox to see if your email filters
                            have identified the email from Dell as spam.</p>
                          <a href="javascript: void(0);" class="badge text-muted bg-light"><em
                              class="mdi mdi-reply"></em> Reply</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="d-flex mb-4">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <p class="text-muted">If you have further questions, please contact Customer Support from the
                        “Action Menu” on your <a href="javascript:void(0);" class="text-decoration-underline">Online
                          Order Support</a>.</p>
                      <a href="javascript: void(0);" class="badge text-muted bg-light"><em class="mdi mdi-reply"></em>
                        Reply</a>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <p class="text-muted">Your <a href="javascript:void(0)" class="text-decoration-underline">Online
                          Order Support</a> provides you with the most current status of your order. To help manage your
                        order refer to the “Action Menu” to initiate return, contact Customer Support and more.</p>
                      ...
                      <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <h5 class="fs-13">
                            <router-link to="/pages/profile" class="text-body">Nancy Martino</router-link> <small
                              class="text-muted">8 sec ago</small>
                          </h5>
                          <p class="text-muted">Other shipping methods are available at checkout if you want your
                ...
                <form class="mt-4">
                  <div class="row g-3">
                    ...
                    <div class="col-12 text-end">
                      <button type="button" class="btn btn-ghost-secondary btn-icon waves-effect me-1"><em
                          class="ri-attachment-line fs-16"></em></button>
                  ...
                  <table class="table table-borderless align-middle mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0"><a href="javascript:void(0)" class="text-body">App pages.zip</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="javascript:void(0);" class="btn btn-light btn-icon" id="dropdownMenuLink1"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                              ...
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-eye-fill me-2 align-middle text-muted"></em>View</a></li>
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-download-2-fill me-2 align-middle text-muted"></em>Download</a></li>
                              <li class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-delete-bin-5-line me-2 align-middle text-muted"></em>Delete</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0"><a href="javascript:void(0);" class="text-body">MedicFollow
                                  admin.ppt</a></h6>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="javascript:void(0);" class="btn btn-light btn-icon" id="dropdownMenuLink2"
                              data-bs-toggle="dropdown" aria-expanded="true">
                              <em class="ri-equalizer-fill"></em>
                            </a>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink3"
                              ...
                              style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 23px);">
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-eye-fill me-2 align-middle"></em>View</a></li>
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-download-2-fill me-2 align-middle"></em>Download</a></li>
                              <li><a class="dropdown-item" href="javascript:void(0);"><em
                                    class="ri-delete-bin-5-line me-2 align-middle"></em>Delete</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0"><a href="javascript:void(0);" class="text-body">Bg-pattern.png</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a href="javascript:void(0);" class="btn btn-light btn-icon" id="dropdownMenuLink4"
                              data-bs-toggle="dropdown" aria-expanded="true">
                              <em class="ri-equalizer-fill"></em>
                            </a>
              ...
              <div class="vstack gap-3">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="fs-13 mb-0"><a href="javascript:void(0);" class="text-body d-block">Nancy Martino</a>
                    </h5>
                  </div>
                  <div class="flex-shrink-0">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="fs-13 mb-0"><a href="javascript:void(0);" class="text-body d-block">Jennifer Carter</a>
                    </h5>
                  </div>
                  <div class="flex-shrink-0">
                    <button type="button" class="btn btn-light btn-sm">Add</button>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="fs-13 mb-0"><a href="javascript:void(0);" class="text-body d-block">Alexis Clarke</a>
                    </h5>
                  </div>
                  <div class="flex-shrink-0">
                    <button type="button" class="btn btn-light btn-sm">Add</button>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="fs-13 mb-0"><a href="javascript:void(0);" class="text-body d-block">Joseph Parker</a>
                    </h5>
                  </div>
                  <div class="flex-shrink-0">
                    <button type="button" class="btn btn-light btn-sm">Add</button>
