...
export default {
  ...
  methods: {
        ...
        for (var i = 1; i <= darray.length; i++) {
          if (darray[i - 1] == val) {
            document.getElementById('productprice' + i).value =
              this.allproductdata[result].price
          }
        }
    ...
    createinvoice() {
      ...
      axios
        .post('https://api-node.themesbrand.website/apps/invoice', data)
        .then((data) => {
          console.log(data)
        })
        .catch((er) => {
                    ...
                    <tr v-for="n in count" :key="n" :id="n" class="product">
                      ...
                      <td>
                        <div class="input-step">
                          <button type="button" @click="minusamount(this)">
                            –
                          </button>
                          <input
                            type="number"
                            ...
                            readonly
                          />
                          <button type="button" @click="plusamount(this)">
                            +
                          </button>
                        </div>
                      </td>
                  ...
                  <tr>
                    <td colspan="9">
                      <a
                        ...
                        ><em class="ri-add-fill me-1 align-bottom"></em> Add
                        Item</a
                      >
                    </td>
                  </tr>
...
All accounts are to be paid within 7 days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be charged the agreed quoted fee noted above.</textarea
              ...
              <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                <button
                  ...
                  @click="createinvoice"
                >
                  <em class="ri-printer-line align-bottom me-1"></em> Save
                </button>
                ...
                <a href="javascript:void(0);" class="btn btn-danger"
                  ><em class="ri-send-plane-fill align-bottom me-1"></em> Send
                  Invoice</a
                >
              </div>
            </div>
