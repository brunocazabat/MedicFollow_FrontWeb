...
export default {
  ...
  data() {
    return {
      ...
      amount: 875,
      billing_address:
        '305 S San Gabriel Blvd, California, United States - 91776',
      ...
      shipping_address:
        '345 Elm Ave, Solvang California, United States - 91776',
  ...
  mounted() {
    if (this.$route.params.id) {
      axios
        .get(
          `https://api-node.themesbrand.website/apps/invoice/${this.$route.params.id}`
        )
        .then((data) => {
          ...
          <div class="card-body p-4">
            <div class="row g-3">
              <div class="col-lg-3 col-6">
                ...
                <h5 class="fs-14 mb-0">
                  <span id="invoice-no">{{ invoiceId }}</span>
                </h5>
              </div>
              <!--end col-->
              <div class="col-lg-3 col-6">
          ...
          <div class="card-body p-4 border-top border-top-dashed">
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <p class="text-muted mb-1" id="billing-address">
                  {{ billing_address }}
                </p>
                <p class="text-muted mb-1" id="billing-phone">
                  Phone: {{ billing_phone }}
                </p>
                <p class="text-muted mb-0" id="billing-tax">
                  Tax: {{ billing_taxno }}
                </p>
              </div>
              <!--end col-->
              <div class="col-sm-6">
                ...
                <p class="text-muted mb-1" id="shipping-address">
                  {{ shipping_address }}
                </p>
                <p class="text-muted mb-0" id="shipping-phone">
                  Phone: {{ shipping_phone }}
                </p>
                <p class="text-muted mb-0" id="shipping-tax">
                  Tax: {{ shipping_taxno }}
                </p>
              </div>
              <!--end col-->
