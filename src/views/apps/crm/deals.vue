...
<template>
    <Layout>
                    ...
                    <div class="col-md-auto ms-auto">
                        <div class="d-flex hastck gap-2 flex-wrap">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#adddeals" class="btn btn-success">
                                <em class="ri-add-fill align-bottom me-1"></em> Add Deals
                            </button>
                            <div class="dropdown">
        ...
        <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                ...
                <div class="card">
                    <a class="card-header bg-soft-danger" data-bs-toggle="collapse" href="#leadDiscovered" role="button"
                        ...
                        <p class="text-muted mb-0">
                            $265,200 <span class="fw-medium">4 Deals</span>
                        </p>
                    </a>
                </div>
                <!--end card-->
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Nesta Technologies
                                    <small class="badge badge-soft-danger">4 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                                </p>
                            ...
                            <div class="card-footer hstack gap-2">
                                <button class="btn btn-warning btn-sm w-100">
                                    <em class="ri-phone-line align-bottom me-1"></em> Call
                                </button>
                                <button class="btn btn-info btn-sm w-100">
                                    <em class="ri-question-answer-line align-bottom me-1"></em>
                                    Message
                                </button>
                            </div>
                        </div>
            ...
            <div class="col">
                <div class="card">
                    <a class="card-header bg-soft-success" data-bs-toggle="collapse" href="#contactInitiated"
                        role="button" aria-expanded="false" aria-controls="contactInitiated">
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-15">
                            Contact Initiated
                        </h5>
                        <p class="text-muted mb-0">
                            $108,700 <span class="fw-medium">5 Deals</span>
                        </p>
                    </a>
                </div>
                <!--end card-->
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Zoetic Fashion
                                    <small class="badge badge-soft-warning">25 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="contactInitiated3">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Micro Design
                                    <small class="badge badge-soft-success">2 Month</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
            ...
            <div class="col">
                <div class="card">
                    <a class="card-header bg-soft-warning" data-bs-toggle="collapse" href="#needsIdentified"
                        role="button" aria-expanded="false" aria-controls="needsIdentified">
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-15">
                            Needs Identified
                        </h5>
                        <p class="text-muted mb-0">
                            $708,200 <span class="fw-medium">7 Deals</span>
                        </p>
                    </a>
                </div>
                <!--end card-->
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Alexis Clarke
                                    <small class="badge badge-soft-danger">7 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Meta4Systems
                                    <small class="badge badge-soft-warning">35 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Syntyce Solutions
                                    <small class="badge badge-soft-danger">15 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified4">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    MedicFollow
                                    <small class="badge badge-soft-danger">3 Month</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified5">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    MedicFollow
                                    <small class="badge badge-soft-danger">3 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    iTest Factory
                                    <small class="badge badge-soft-warning">42 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card">
                        ...
                        <div class="collapse border-top border-top-dashed" id="needsIdentified7">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Meta4Systems
                                    <small class="badge badge-soft-success">6 Month</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
            ...
            <div class="col">
                <div class="card">
                    <a class="card-header bg-soft-info" data-bs-toggle="collapse" href="#meetingArranged" role="button"
                        ...
                        <p class="text-muted mb-0">
                            $44,900 <span class="fw-medium">3 Deals</span>
                        </p>
                    </a>
                </div>
                <!--end card-->
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Nesta Technologies
                                    <small class="badge badge-soft-danger">10 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
            ...
            <div class="col">
                <div class="card">
                    <a class="card-header bg-soft-secondary" data-bs-toggle="collapse" href="#offerAccepted"
                        role="button" aria-expanded="false" aria-controls="offerAccepted">
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-15">
                            Offer Accepted
                        </h5>
                        <p class="text-muted mb-0">
                            $819,300 <span class="fw-medium">8 Deals</span>
                        </p>
                    </a>
                </div>
                <!--end card-->
                <div class="collapse show" id="offerAccepted">
                    ...
                    <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <div class="card-body">
                            <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2"
                                role="button" aria-expanded="false" aria-controls="offerAccepted2">
                                <div class="flex-shrink-0">
                        ...
                        <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Nesta Technologies
                                    <small class="badge badge-soft-warning">47 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="collapse border-top border-top-dashed" id="offerAccepted4">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Nesta Technologies
                                    <small class="badge badge-soft-success">4 Month</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <div class="card-body">
                            <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5"
                                role="button" aria-expanded="false" aria-controls="offerAccepted5">
                                <div class="flex-shrink-0">
                    ...
                    <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <div class="collapse border-top border-top-dashed" id="offerAccepted6">
                            <div class="card-body">
                                <h6 class="fs-14 mb-1">
                                    Nesta Technologies
                                    <small class="badge badge-soft-danger">14 Days</small>
                                </h6>
                                <p class="text-muted">
                                    As a company grows however, you find it's not as easy to shout
                                    across
                    ...
                    <div class="card mb-1">
                        <div class="card-body">
                            <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted7"
                                role="button" aria-expanded="false" aria-controls="offerAccepted7">
                                <div class="flex-shrink-0">
                                    <img src="@/assets/images/brands/github.png" alt=""
                                        class="avatar-xs rounded-circle shadow" />
                                </div>
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <flat-pickr v-model="date" placeholder="Select date" class="form-control"></flat-pickr>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success">
                                <em class="ri-save-line align-bottom me-1"></em> Save
                            </button>
                        </div>
                    </form>
                </div>
