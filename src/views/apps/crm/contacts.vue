...
export default {
  ...
  methods: {
    ...
    editdata(data) {
      ...
      document.getElementById('companyname').value =
        this.contactsList[result].company
      ...
      document.getElementById('leadscore').value =
        this.contactsList[result].lead_score
      this.tagvalue = this.contactsList[result].tags
      document.getElementById('date').value =
        this.contactsList[result].last_contacted
      document.getElementById('edit-btn').style.display = 'block'
      document.getElementById('add-btn').style.display = 'none'
    },
    updateorder() {
      let result = this.contactsList.findIndex(
      ...
      axios
        .patch(
          `https://api-node.themesbrand.website/apps/contact/${
    ...
    addorder() {
      ...
      if (
        ...
        axios
          .post(`https://api-node.themesbrand.website/apps/contact`, data)
          .then(() => {})
          .catch((er) => {
            console.log(er)
          })
    ...
    deletedata(event) {
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios
            .delete(
              `https://api-node.themesbrand.website/apps/contact/${event._id}`
            )
            .then(() => {})
            .catch((er) => {
              console.log(er)
  ...
  beforeMount() {
    axios
      .get('https://api-node.themesbrand.website/apps/contact')
      .then((data) => {
        const monthNames = [
          'Jan',
          'Feb',
            ...
            <div class="d-flex align-items-center flex-wrap gap-2">
              <div class="flex-grow-1">
                <button
                  ...
                  @click="addnew"
                >
                  <em class="ri-add-fill me-1 align-bottom"></em> Add Contacts
                </button>
              ...
              <div class="flex-shrink-0">
                <div class="hstack text-nowrap gap-2">
                  ...
                  <button class="btn btn-soft-success shadow-none">
                    Import
                  </button>
                  <button
                    type="button"
                ...
                >
                  ...
                  <tbody class="list form-check-all">
                    <tr v-for="(data, index) of resultQuery" :key="index">
                      ...
                      <td>
                        <span class="date">{{ data.last_contacted }}</span
              ...
              <table class="table table-borderless mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span id="lastdate">15 Dec, 2021 </span
                      ><small class="text-muted" id="lasttime">08:58AM</small>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <form action="" id="addform">
            <div class="modal-body">
              ...
              <div class="row g-3">
                ...
                <div class="col-lg-12">
                  <div>
                    <label for="designation-field" class="form-label"
