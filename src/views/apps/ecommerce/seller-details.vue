        ...
        <div class="card">
          ...
          <div class="card-body p-4 border-top border-top-dashed">
            ...
            <div class="text-center mt-3">
              <a href="javascript:void(0)" class="link-primary"
                >View All Reviews
                <em class="ri-arrow-right-line align-bottom ms-1"></em
              ></a>
            </div>
          </div>
          <div class="card-body p-4 border-top border-top-dashed">
            ...
            <form action="#">
              ...
              <div class="text-end">
                <button type="submit" class="btn btn-primary">
                  <em class="ri-mail-send-line align-bottom me-1"></em> Send
                  Messages
                </button>
              </div>
            </form>
                    ...
                    <td data-column-id="rating" class="gridjs-td">
                      <span
                        ><span class="badge bg-light text-body fs-12 fw-medium"
                          ><em class="mdi mdi-star text-warning me-1"></em
                          >{{ data.rating }}</span
                        ></span
                      >
                    </td>
