<script>
    ...
    export default {
        ...
        mounted() {
            ...
            document.querySelector('.currentyear').innerHTML = new Date().getFullYear() + " © MedicFollow - MedicFollow";
        },
    };
</script>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with
                                <span class="text-success">MedicFollow </span></h1>
                            <p class="lead text-muted lh-base">MedicFollow is a fully responsive, multipurpose and premium
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    <div class="col-sm">
                        <div>
                            <h4 class="text-white mb-0 fw-semibold">Build your web App/SaaS with MedicFollow dashboard</h4>
                        </div>
                    </div>
                    <!-- end col -->
                        ...
                        <div>
                            ...
                            <div class="mt-4 fs-13">
                                ...
                                <p class="ff-secondary">You can build any type of web application like eCommerce, CRM,
                                    CMS, Project
                                    management apps, Admin Panels, etc using MedicFollow.</p>
                            </div>
                        </div>
                    </div>
