        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="">
            <router-link
              ...
              >Sign in</router-link
            >
            <router-link to="/auth/signup-basic" class="btn btn-primary"
              >Sign Up</router-link
            >
          </div>
        </div>
          ...
          <div class="col-lg-8 col-sm-10">
            <div class="text-center mt-lg-5 pt-5">
              ...
              <p class="lead text-muted lh-base">
                MedicFollow is a fully responsive, multipurpose and premium
                Bootstrap 5 Admin & Dashboard Template built in multiple
                frameworks.
              </p>

              <div class="d-flex gap-2 justify-content-center mt-4">
                <a href="auth-signup-basic.html" class="btn btn-primary"
                  >Get Started
                  <em class="ri-arrow-right-line align-middle ms-1"></em
                ></a>
                <router-link to="/pages/pricing" class="btn btn-danger"
                  >View Plans <em class="ri-eye-line align-middle ms-1"></em
                ></router-link>
              </div>
            </div>
            ...
            <div class="d-flex p-3">
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  ...
                  >
                    <em class="ri-pencil-ruler-2-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
                ...
                <div>
                  <a href="#" class="fs-13 fw-medium"
                    >Learn More
                    <em class="ri-arrow-right-s-line align-bottom"></em
                  ></a>
                </div>
              </div>
            </div>
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-palette-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
                ...
                <p class="text-muted my-3 ff-secondary">
                  The collection of rules and guidelines which designers use to
                  communicate with users through appealing.
                </p>
                <div>
                  <a href="#" class="fs-13 fw-medium"
                    >Learn More
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-lightbulb-flash-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-customer-service-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
                ...
                <p class="text-muted my-3 ff-secondary">
                  Awesome Support is the most versatile and feature-rich support
                  plugin for all version.
                </p>
                <div>
                  <a href="#" class="fs-13 fw-medium"
                    >Learn More
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-stack-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-settings-2-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-slideshow-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-google-fill fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
              ...
              <div class="flex-shrink-0 me-3">
                <div class="avatar-sm icon-effect">
                  <div
                    class="avatar-title bg-transparent text-success rounded-circle"
                  >
                    <em class="ri-briefcase-5-line fs-36"></em>
                  </div>
                </div>
              </div>
              <div class="flex-grow-1">
          ...
          <div class="col-lg-6">
            <div class="text-muted">
              <div class="avatar-sm icon-effect mb-4">
                ...
                >
                  <em class="ri-collage-line fs-36"></em>
                </div>
              </div>
              <h3 class="mb-3 fs-20">Huge collection of widgets</h3>
              <p class="mb-4 ff-secondary fs-16">
                Collection widgets specialize in displaying many elements of the
                same type, such as a collection of pictures from a collection of
                articles from a news app or a collection of messages from a
                communication app.
              </p>
          ...
          <div class="col-sm">
            <div>
              <h4 class="text-white mb-0 fw-semibold">
                Build your web App/SaaS with MedicFollow dashboard
              </h4>
            </div>
          </div>
          <!-- end col -->
          <div class="col-sm-auto">
            <div>
              <a
                ...
                ><em class="ri-shopping-cart-2-line align-middle me-1"></em> Buy
                Now</a
              >
            </div>
          </div>
          ...
          <div class="col-lg-6 order-2 order-lg-1">
            <div class="text-muted">
              ...
              <p class="mb-4 ff-secondary">
                ...
                management that is integrated into the Electronic Health Record
                (EHR).
              </p>
            ...
            <div class="text-center mb-5">
              ...
              <div class="d-flex justify-content-center align-items-center">
                ...
                <div>
                  <h5 class="fs-14 mb-0">
                    Annual
                    <span class="badge badge-soft-success">Save 20%</span>
                  </h5>
                </div>
              </div>
            </div>
            ...
            <div class="card plan-box mb-0">
              <div class="card-body p-4 m-2">
                ...
                <div class="py-4 text-center">
                  <h1 class="month">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">19</span>
                    <span class="fs-13 text-muted">/Month</span>
                  </h1>
                  <h1 class="annual">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">171</span>
                ...
                <div>
                  <ul
                    class="list-unstyled text-muted vstack gap-3 ff-secondary"
                  >
                    <li>
                      <div class="d-flex">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar-sm">
                    <div
                      class="avatar-title bg-light rounded-circle text-primary"
                    >
                      <em class="ri-medal-fill fs-20"></em>
                    </div>
                  </div>
                </div>
                <div class="py-4 text-center">
                  <h1 class="month">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">29</span>
                    <span class="fs-13 text-muted">/Month</span>
                  </h1>
                  <h1 class="annual">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">261</span>
                    <span class="fs-13 text-muted">/Year</span>
                  </h1>
                </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="avatar-sm">
                    <div
                      class="avatar-title bg-light rounded-circle text-primary"
                    >
                      <em class="ri-stack-fill fs-20"></em>
                    </div>
                  </div>
                </div>
                <div class="py-4 text-center">
                  <h1 class="month">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">39</span>
                    <span class="fs-13 text-muted">/Month</span>
                  </h1>
                  <h1 class="annual">
                    <sup><small>$</small></sup
                    ><span class="ff-secondary fw-bold">351</span>
                    <span class="fs-13 text-muted">/Year</span>
                  </h1>
                </div>
          ...
          <div class="col-lg-6">
            ...
            >
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body ff-secondary">
                    ...
                    hierarchy, we might find it useful to follow the example of
                    a single book.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body ff-secondary">
                    ...
                    individual Theme Feature that the author wishes to support.
                    Theme support functions should be called in the theme's
                    functions.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body ff-secondary">
                    Simple is a free WordPress theme, by Themify, built exactly
                    what it is named for: simplicity. Immediately upgrade the
                    quality of your WordPress site with the simple theme To use
                    the built-in Chrome theme editor.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            ...
            >
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body ff-secondary">
                    ...
                    settings. You can choose to make the document white or black
                    using the Switch Modes button in the ribbon's View tab.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body ff-secondary">
                    A short story, novella, or novel presents a narrative to its
                    reader. Perhaps that narrative involves mystery, terror,
                    romance, comedy, or all of the above. These works of fiction
                    may also contain memorable characters, vivid world-building,
                    literary devices.
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="text-center">
              <div>
                <em class="ri-double-quotes-l text-success display-3"></em>
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="text-center mb-5">
              <h3 class="mb-3 fw-semibold">
                Our <span class="text-danger">Team</span>
              </h3>
              <p class="text-muted mb-4 ff-secondary">
                To achieve this, it would be necessary to have uniform grammar,
                pronunciation and more common words. If several languages
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <div class="card-body text-center p-4">
                ...
                <!-- end card body -->
                <h5 class="mb-1">
                  <a href="pages-profile.html" class="text-body">Henry Baird</a>
                </h5>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <div class="card-body text-center p-4">
                ...
                <!-- end card body -->
                <h5 class="mb-1">
                  <a href="pages-profile.html" class="text-body">Frank Hook</a>
                </h5>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <div class="card-body text-center p-4">
                ...
                <!-- end card body -->
                <h5 class="mb-1">
                  <a href="pages-profile.html" class="text-body">Marie Ward</a>
                </h5>
                <p class="text-muted mb-0 ff-secondary">Full Stack Developer</p>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <div class="card-body text-center p-4">
                ...
                <!-- end card body -->
                <h5 class="mb-1">
                  <a href="pages-profile.html" class="text-body">Jack Gough</a>
                </h5>
          ...
          <div class="col-lg-12">
            <div class="text-center mt-2">
              <a href="pages-team.html" class="btn btn-primary"
                >View All Members
                <em class="ri-arrow-right-line ms-1 align-bottom"></em
              ></a>
            </div>
          </div>
        </div>
            ...
            <div>
              <div class="mt-4">
                ...
                <div class="ff-secondary fw-semibold">
                  4461 Cedar Street Moro, <br />AR 72368
                </div>
              </div>
              <div class="mt-4">
                <h5 class="fs-13 text-muted text-uppercase">
                ...
                <div class="ff-secondary fw-semibold">
                  2467 Swick Hill Street <br />New Orleans, LA
                </div>
              </div>
              <div class="mt-4">
            ...
            <div>
              ...
              <div class="mt-4 fs-13">
                ...
                <p class="ff-secondary">
                  ...
                  CMS, Project management apps, Admin Panels, etc using
                  MedicFollow.
                </p>
              </div>
            </div>
              ...
              <div class="col-sm-4 mt-4">
                ...
                <div class="text-muted mt-3">
                  <ul class="list-unstyled ff-secondary footer-list">
                    ...
                    <li>
                      <router-link to="/apps/projects-list"
              ...
              <div class="col-sm-4 mt-4">
                ...
                <div class="text-muted mt-3">
                  <ul class="list-unstyled ff-secondary footer-list">
                    ...
                    <li>
                      <router-link to="/apps/tasks-kanban"
