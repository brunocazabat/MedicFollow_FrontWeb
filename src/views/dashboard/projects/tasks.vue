      ...
      <div class="flex-shrink-0">
        <div class="dropdown card-header-dropdown">
          <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            <span class="text-muted">All Tasks <em class="mdi mdi-chevron-down ms-1"></em></span>
          </a>
            ...
            <tr>
              ...
              <td>
                <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top"
                  ...
                  <img src="@/assets/images/users/avatar-1.png" alt="" class="rounded-circle avatar-xxs shadow" />
                </a>
              </td>
            </tr>
            <!-- end -->
