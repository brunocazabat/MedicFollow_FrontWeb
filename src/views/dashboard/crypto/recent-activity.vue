        ...
        <div class="dropdown card-header-dropdown">
          ...
          >
            ...
            ><span class="text-muted"
              >Current Week<em class="mdi mdi-chevron-down ms-1"></em
            ></span>
          </a>
      ...
      <div data-simplebar style="height: 390px">
        <div class="p-3">
          <template v-for="(item, index) of recentActivity" :key="index">
            ...
            >
              <div class="avatar-xs flex-shrink-0">
                <span class="avatar-title bg-light rounded-circle shadow">
                  ...
                  <template v-if="item.feaIcon == 'send'">
                    <SendIcon class="icon-dual-warning icon-sm"> </SendIcon>
                  </template>
                </span>
              </div>
              ...
              <div class="flex-shrink-0 text-end">
                <h6 :class="`mb-1 text-${item.coinActivityClass}`">
                  {{ item.coinActivity
                  }}<span class="text-uppercase ms-1">{{ item.coinName }}</span>
                </h6>
            ...
            <h6
              v-if="item.isDate == true"
              class="text-muted text-uppercase mb-3 fs-11"
            >
              {{ item.date }}
            </h6></template
          >
