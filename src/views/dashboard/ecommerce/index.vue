                  ...
                  <form action="javascript:void(0);">
                    <div class="row g-3 mb-0 align-items-center">
                      ...
                      <div class="col-auto">
                        ...
                        >
                          <em class="ri-add-circle-line align-middle me-1"></em>
                          Add Product
                        </button>
                      </div>
                      <!--end col-->
                  ...
                  >
                    ...
                    <div class="avatar-sm flex-shrink-0">
                      <span class="avatar-title bg-success rounded fs-3">
                        <em class="bx bx-dollar-circle"></em>
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="dropdown card-header-dropdown">
                      ...
                      >
                        ...
                        ><span class="text-muted"
                          >Today<em class="mdi mdi-chevron-down ms-1"></em
                        ></span>
                      </a>
                ...
                <div class="card-header align-items-center d-flex">
                  ...
                  <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                      ...
                      >
                        <span class="text-muted"
                          >Report<em class="mdi mdi-chevron-down ms-1"></em
                        ></span>
                      </a>
                      <div class="dropdown-menu dropdown-menu-end">
                ...
                <div>
                  ...
                  >
                    ...
                    <swiper-slide>
                      <div class="swiper-slide">
                        <div
                          class="card border border-dashed shadow-none shadow"
                        >
                          <div class="card-body">
                            <div class="d-flex">
                              <div class="flex-shrink-0">
                ...
                <div class="mt-3">
                  <div class="row align-items-center g-2">
                    ...
                    <div class="col">
                      <div class="p-1">
                        <div
                          class="progress animated-progess bg-soft-success progress-sm"
                        >
                          <div
                  ...
                  <div class="row align-items-center g-2">
                    ...
                    <div class="col">
                      <div class="p-1">
                        <div
                          class="progress animated-progess bg-soft-warning progress-sm"
                        >
                          <div
                  ...
                  <div class="row align-items-center g-2">
                    ...
                    <div class="col">
                      <div class="p-1">
                        <div
                          class="progress animated-progess bg-soft-danger progress-sm"
                        >
                          <div
