                ...
                <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3 active" id="pills-bill-info-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="true">
                      <em
                        class="ri-user-2-line fs-16 p-2 bg-soft-primary text-primary rounded-circle align-middle me-2"></em>
                      Personal Info
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3" id="pills-payment-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <em
                        class="ri-bank-card-line fs-16 p-2 bg-soft-primary text-primary rounded-circle align-middle me-2"></em>
                      Payment Info
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3" id="pills-finish-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <em
                        class="ri-checkbox-circle-line fs-16 p-2 bg-soft-primary text-primary rounded-circle align-middle me-2"></em>Finish
                    </button>
                  </li>
                </ul>
              </div>
                  ...
                  <div>
                    ...
                    <div class="d-flex align-items-start gap-3 mt-3">
                      <button type="button" class="btn btn-primary btn-label right ms-auto nexttab"
                        ...
                        <em class="ri-truck-line label-icon align-middle fs-16 ms-2"></em>Proceed to Shipping
                      </button>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade" id="pills-bill-address" role="tabpanel"
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="form-check card-radio">
                          ...
                          <label class="form-check-label" for="shippingAddress01">
                            ...
                            <span class="text-muted fw-normal text-wrap mb-1 d-block">4739 Bubby Drive Austin, TX
                              78729</span>
                        ...
                        <div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                          <div>
                            <a href="#" class="d-block text-body p-1 px-2" data-bs-toggle="modal"
                              data-bs-target="#addAddressModal"><em
                                class="ri-pencil-fill text-muted align-bottom me-1"></em>
                              Edit</a>
                          </div>
                          <div>
                            <a href="#" class="d-block text-body p-1 px-2" data-bs-toggle="modal"
                              data-bs-target="#removeItemModal"><em
                                class="ri-delete-bin-fill text-muted align-bottom me-1"></em>
                              Remove</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4 col-sm-6">
                        <div class="form-check card-radio">
                          ...
                          <label class="form-check-label" for="shippingAddress02">
                            ...
                            <span class="text-muted fw-normal text-wrap mb-1 d-block">1246 Virgil Street Pensacola, FL
                              32501
                            </span>
                            <span class="text-muted fw-normal d-block">Mo. 012-345-6789</span>
                          </label>
                  ...
                  <div class="d-flex align-items-start gap-3 mt-4">
                    <button type="button" class="btn btn-light btn-label previestab"
                      ...
                      <em class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></em>Back to Personal Info
                    </button>
                    <button type="button" class="btn btn-primary btn-label right ms-auto nexttab"
                      data-nexttab="pills-payment-tab">
                      <em class="ri-bank-card-line label-icon align-middle fs-16 ms-2"></em>Continue to Payment
                    </button>
                  </div>
                </div>
                <!-- end tab pane -->
                ...
                <div class="tab-pane fade" id="pills-payment" role="tabpanel" aria-labelledby="pills-payment-tab">
                      ...
                      <div data-bs-toggle="collapse" data-bs-target="#paymentmethodCollapse.show" aria-expanded="false"
                        ...
                        <div class="form-check card-radio">
                          ...
                          <label class="form-check-label" for="paymentMethod01">
                            <span class="fs-16 text-muted me-2"><em class="ri-paypal-fill align-bottom"></em></span>
                      ...
                      <div data-bs-toggle="collapse" data-bs-target="#paymentmethodCollapse" aria-expanded="true"
                        ...
                        <div class="form-check card-radio">
                          ...
                          <label class="form-check-label" for="paymentMethod02">
                            <span class="fs-16 text-muted me-2"><em class="ri-bank-card-fill align-bottom"></em></span>
                      ...
                      <div data-bs-toggle="collapse" data-bs-target="#paymentmethodCollapse.show" aria-expanded="false"
                        ...
                        <div class="form-check card-radio">
                          ...
                          <label class="form-check-label" for="paymentMethod03">
                            <span class="fs-16 text-muted me-2"><em
                                class="ri-money-dollar-box-fill align-bottom"></em></span>
                  ...
                  <div class="d-flex align-items-start gap-3 mt-4">
                    <button type="button" class="btn btn-light btn-label previestab"
                      ...
                      <em class="ri-arrow-left-line label-icon align-middle fs-16 me-2"></em>Back to Shipping
                    </button>
                    <button type="button" class="btn btn-primary btn-label right ms-auto nexttab"
                      data-nexttab="pills-finish-tab">
                      <em class="ri-shopping-basket-line label-icon align-middle fs-16 ms-2"></em>Complete Order
                    </button>
                  </div>
                </div>
                <!-- end tab pane -->
