...
export default {
  ...
  methods: {
    ...
    async getObservations() {
      ...
      // Setting the last checkup text
      this.lastCheckup = this.observationsArray[0];
    },
    parseDate(date) {
...
<template>
  ...
  <div>
    <div class="card card-body" v-for='(observations, index) in observationsArray' :key='index'>
                ...
                <div class="border rounded border-dashed p-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                      <h5 class="fs-13 mb-1"><a href="#" class="text-body text-truncate d-block">File placeholder</a>
                      </h5>
                      <div>2.6MB</div>
                    </div>
