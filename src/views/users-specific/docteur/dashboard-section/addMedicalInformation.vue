  ...
  <div class="card dashboardcard">
    <div class="card-body align-content-center align-items-center text-center">
      <div class="row">
        ...
        <h2 class="mb-3 text-center text-muted text-uppercase">{{$t("t-addmedicalinfo")}}</h2>
        <div class="card-footer border-0">
          <div class="row">
            <div class="text-center">
              <button class="btn btn-primary text-uppercase padd25around col-sm-6 fs-16">{{$t("t-add")}}</button>
            </div>
          </div>
        </div>
      </div>
