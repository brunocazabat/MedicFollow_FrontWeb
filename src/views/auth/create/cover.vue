                  ...
                  <div class="p-lg-5 p-4">
                    ...
                    <div class="p-2">
                      <form>
                        ...
                        <div class="mt-4">
                          <button class="btn btn-success w-100" @click="validatepassword" type="submit">
                            Reset Password
                          </button>
                        </div>
                      </form>
                    ...
                    <div class="mt-5 text-center">
                      <p class="mb-0">
                        ...
                        <a href="auth-signin-cover" class="fw-semibold text-primary text-decoration-underline">
                          Click here
                        </a>
                      </p>
                    </div>
