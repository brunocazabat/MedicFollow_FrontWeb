                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="user-thumb text-center">
                                                <img src="@/assets/images/users/avatar-1.png" class="rounded-circle img-thumbnail avatar-lg shadow" alt="thumbnail">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Not you ? return <router-link to="/auth/signin-cover" class="fw-semibold text-primary text-decoration-underline"> Signin</router-link></p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
