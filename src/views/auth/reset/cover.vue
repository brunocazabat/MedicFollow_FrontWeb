                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4">
                    ...
                    <div class="mt-2 text-center">
                      <lottie class="avatar-xl" colors="primary:#0ab39c,secondary:#4b38b3" :options="defaultOptions"
                    ...
                    <div class="mt-5 text-center">
                      <p class="mb-0">Wait, I remember my password... <router-link to="/auth/signin-cover"
                          class="fw-semibold text-primary text-decoration-underline"> Click here </router-link>
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-center">
              <p class="mb-0">&copy; {{ new Date().getFullYear() }} MedicFollow. Crafted with <em
