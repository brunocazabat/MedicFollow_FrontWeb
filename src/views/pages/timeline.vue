          ...
          <div class="timeline">
              ...
              <div class="content">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <p class="text-muted mb-2">Wish someone a sincere ‘good luck in your new job’ with these sweet
                      messages. Make sure you pick out a good luck new job card to go with the words, and pop a
                      beautiful bunch of flowers from our gift range in your basket, to make them feel super special.
                    </p>
                  ...
                  <div class="col-sm-6">
                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                      ...
                      <div class="flex-grow-1 overflow-hidden ms-2">
                        <h6 class="text-truncate mb-0"><a href="javascript:void(0);" class="stretched-link">Business
                            Template - UI/UX design</a></h6>
                        <small>685 KB</small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="d-flex border border-dashed p-2 rounded position-relative">
                      ...
                      <div class="flex-grow-1 ms-2 overflow-hidden">
                        <h6 class="mb-0 text-truncate"><a href="javascript:void(0);" class="stretched-link">Bank
                            Management System - PSD</a></h6>
                        <small>8.78 MB</small>
                      </div>
                    </div>
                  </div>
            ...
            <div class="timeline-item left">
              ...
              <div class="content">
                ...
                <p class="text-muted">Every team project can have a velzon. Use the velzon to share information with
                  your team to understand and contribute to your project.</p>
                <div class="avatar-group mb-2">
                  <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                    <img src="@/assets/images/users/avatar-1.png" alt="" class="rounded-circle avatar-xs">
                  </a>
                  <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                    <img src="@/assets/images/users/avatar-1.png" alt="" class="rounded-circle avatar-xs">
                  </a>
                  <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
            ...
            <div class="timeline-item right">
              ...
              <div class="content">
                ...
                <p class="text-muted fst-italic mb-2">" This is an awesome admin dashboard template. It is extremely
                  well structured and uses state of the art components (e.g. one of the only templates using boostrap
                  5.1.3 so far). I integrated it into a Rails 6 project. Needs manual integration work of course but the
                  template structure made it easy. "</p>
                <div class="hstack gap-2">
            ...
            <div class="timeline-item left">
              ...
              <div class="content">
                ...
                <p class="text-muted">Powerful, clean & modern responsive bootstrap 5 admin template. The maximum file
                  size for uploads in this demo :</p>
            ...
            <div class="timeline-item right">
              ...
              <div class="content">
                ...
                <a href="javascript:void(0);" class="link-primary text-decoration-underline">Read More <em
                    class="ri-arrow-right-line"></em></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="timeline-continue">
                  ...
                  <div class="timeline-box shadow">
                    <div class="timeline-text">
                      ...
                      <p class="text-muted">In the trip planner, keep only one or two activities in a day if the purpose
                        of the trip is to relax and take it easy during the vacation :</p>
                      <div class="row border border-dashed rounded gx-2 p-2">
                        <div class="col-3">
                          <a href="javascript:void(0);"><img src="@/assets/images/small/img-7.jpg" alt=""
                              class="img-fluid rounded shadow"></a>
                        </div>
                        <!--end col-->
                        <div class="col-3">
                          <a href="javascript:void(0);"><img src="@/assets/images/small/img-3.jpg" alt=""
                              class="img-fluid rounded shadow"></a>
                        </div>
                        <!--end col-->
                        <div class="col-3">
                          <a href="javascript:void(0);"><img src="@/assets/images/small/img-10.jpg" alt=""
                              class="img-fluid rounded shadow"></a>
                        </div>
                        <!--end col-->
                        <div class="col-3">
                          <a href="javascript:void(0);"><img src="@/assets/images/small/img-9.jpg" alt=""
                              class="img-fluid rounded shadow"></a>
                        </div>
                        <!--end col-->
                      </div>
              ...
              <div class="row timeline-right">
                ...
                <div class="col-12">
                  <div class="timeline-box shadow">
                    <div class="timeline-text">
                      <h5>MedicFollow - Project Discussion</h5>
                      <p class="text-muted mb-0">The purpose of the discussion is to interpret and describe the
                        significance of your findings in light of what was already known about the research problem
                        being investigated, and to explain any new understanding or fresh insights about the problem
                        after you've taken the findings into consideration.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-12">
                  <div class="timeline-box shadow">
                    <div class="timeline-text">
                      ...
                      <p class="text-muted mb-0">A client meeting, meaning, direct collaboration and communication with
                        a customer, is the best way to understand their needs and how you can help support them.</p>
                    </div>
                  </div>
                </div>
              </div>
