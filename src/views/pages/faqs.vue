            ...
            <div class="row">
              <div class="col-xxl-5 align-self-center">
                <div class="py-4">
                  ...
                  <p class="text-success fs-15 mt-3">If you can not find answer to your question in our FAQ, you can
                    always contact us or email us. We will answer you shortly!</p>
                  <div class="hstack flex-wrap gap-2">
                    <button type="button" class="btn btn-primary btn-label rounded-pill"><em
                        class="ri-mail-line label-icon align-middle rounded-pill fs-16 me-2"></em> Email Us</button>
                    <button type="button" class="btn btn-info btn-label rounded-pill"><em
                        class="ri-twitter-line label-icon align-middle rounded-pill fs-16 me-2"></em> Send Us
                      Tweet</button>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion accordion-border-box" id="genques-accordion">
                <div class="accordion-item shadow">
                  ...
                  <div id="genques-collapseOne" class="accordion-collapse collapse show"
                    ...
                    <div class="accordion-body">
                      ...
                      than the existing European languages. It will be as simple their most common words.
                    </div>
                  </div>
                </div>
                <div class="accordion-item shadow">
                  ...
                  <div id="genques-collapseTwo" class="accordion-collapse collapse" aria-labelledby="genques-headingTwo"
                    ...
                    <div class="accordion-body">
                      The new common language will be more simple and regular than the existing European languages. It
                      will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will
                ...
                <div class="accordion-item shadow">
                  ...
                  <div id="genques-collapseThree" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                      he wise man therefore always holds in these matters to this principle of selection: he rejects
                      pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains.But I
                      must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born
              ...
              <div class="accordion accordion-border-box" id="privacy-accordion">
                <div class="accordion-item shadow">
                  <h2 class="accordion-header" id="privacy-headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                      data-bs-target="#privacy-collapseOne" aria-expanded="true" aria-controls="privacy-collapseOne">
                      Why do we use it ?
                    </button>
                  </h2>
