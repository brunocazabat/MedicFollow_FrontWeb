...
export default {
  ...
  methods: {
    ...
    isNotificationEnabled() {
      let oui = document.getElementById("desktopNotification");
      if (Notification.permission !== "granted") {
        this.notification = false;
        if (oui.classList.contains("green") || !oui.classList.contains("red")) {
          oui.classList.remove("green");
          oui.classList.add("red");
          oui.checked = false;
        }
      } else {
        this.notification = true;
        if (oui.classList.contains("red") || !oui.classList.contains("green")) {
          oui.classList.remove("red");
          oui.classList.add("green");
          oui.checked = true;
        }
      }
...
.green {
  background-color: #1dac90 !important;
}
</style>
