...
export default [
  {
    path: "/maintenance",
    name: "maintenance",
    meta: { title: "Maintenance", onceLoggedIn: onceLoggedIn },
    component: () => import("@/views/UNIVERSAL/errors-section/maintenance.vue"),
  },
  {
    path: "/403",
    name: "403-error",
    meta: { title: "Error 403", onceLoggedIn: onceLoggedIn },
    component: () => import("@/views/UNIVERSAL/errors-section/403.vue"),
  },
  {
    path: "/500",
    name: "500-error",
    meta: { title: "Error 500", onceLoggedIn: onceLoggedIn },
    component: () => import("@/views/UNIVERSAL/errors-section/500.vue"),
  },
  {
    path: "/:pathMatch(.*)*",
    name: "404-error",
    meta: { title: "Error 404", onceLoggedIn: onceLoggedIn },
