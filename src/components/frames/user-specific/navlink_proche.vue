    ...
    <li class="nav-item">
      ...
      <div class="collapse menu-dropdown" id="sidebarApps">
        <ul class="nav nav-sm flex-column">
          <li class="nav-item">
            <router-link to="/proche/suggestions" class="nav-link" data-key="t-suggest">
              {{ $t("t-suggest") }}
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/proche/bug-report" class="nav-link" data-key="t-report">
              {{ $t("t-report") }}
            </router-link>
          </li>
        </ul>
